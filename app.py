...
# BUSINESS_NAME = "Destiny Engineers - Construction & Interior Company in Balaghat"
...
# # ================== Google Review URL ==================
# GOOGLE_REVIEW_URL = "https://g.page/r/Ccfr9z28wyNSEAE/review"
...
# st.set_page_config(page_title="Destiny Engineers - Construction & Interior Company in Balaghat Review Picker", page_icon="⭐", layout="centered")
...
#     <h1 class="title-text">⭐ Welcome to Destiny Engineers - Construction & Interior Company in Balaghat Review Page</h1>
# """, unsafe_allow_html=True)
...
st.set_page_config(page_title="Destiny Engineers Construction & Interior in Balaghat", layout="wide")
